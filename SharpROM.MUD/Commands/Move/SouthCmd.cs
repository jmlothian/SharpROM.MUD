...
namespace SharpROM.MUD.Commands.Move
{
    public class SouthCmd : IMUDCommand
    {
        ...
        public SouthCmd(IEventRoutingService evtRoutingService, GameDataManager dataManager, MUDMainEventHandler MudEvents)
        {
        ...
        {
            ExitInfo exit = DataManager.GetExitFromDir(user.EntityInfo.RoomVNUM, "south");
