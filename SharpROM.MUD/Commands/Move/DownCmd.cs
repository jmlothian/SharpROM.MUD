...
{
    public class DownCmd : IMUDCommand
    {
        ...
        public DownCmd(IEventRoutingService evtRoutingService, GameDataManager dataManager, MUDMainEventHandler MudEvents)
        {
        ...
        {
            ExitInfo exit = DataManager.GetExitFromDir(user.EntityInfo.RoomVNUM, "down");
