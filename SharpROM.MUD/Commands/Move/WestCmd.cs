...
{
    public class WestCmd : IMUDCommand
    {
        ...
        public WestCmd(IEventRoutingService evtRoutingService, GameDataManager dataManager, MUDMainEventHandler MudEvents)
        {
        ...
        {
            ExitInfo exit = DataManager.GetExitFromDir(user.EntityInfo.RoomVNUM, "west");
