...
namespace SharpROM.MUD.Commands.Move
{
    public class NorthCmd : IMUDCommand
    {
        ...
        public NorthCmd(IEventRoutingService evtRoutingService, GameDataManager dataManager, MUDMainEventHandler MudEvents)
        {
        ...
        {
            ExitInfo exit = DataManager.GetExitFromDir(user.EntityInfo.RoomVNUM, "north");
